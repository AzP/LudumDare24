...
set background=dark
set backspace=2
set cinoptions=>s,e0,n0,f0,{0,:s,=s,l1,g0,t0,+s,(s,U1,:0,p0
...
set tabpagemax=20
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,~/.vimtags,~/diverse/programmering/LudumDare/24/.git/cpp.tags,~/diverse/programmering/LudumDare/24/.git/tags
...
silent only
cd ~/diverse/programmering/LudumDare/24/client/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/diverse/programmering/LudumDare/24/client/src/main.cpp
args main.cpp
edit ~/diverse/programmering/LudumDare/24/client/src/main.cpp
...
exe 'vert 1resize ' . ((&columns * 135 + 88) / 176)
exe 'vert 2resize ' . ((&columns * 40 + 88) / 176)
argglobal
...
setlocal cinoptions=>s,e0,n0,f0,{0,:s,=s,l1,g0,t0,+s,(s,U1,:0,p0
...
setlocal statusline=%#StatColor#%F%*%m%r%h%w\ [FORMAT=%{&ff}]\ [TYPE=%Y]\ [ASCII=%03.3b]\ [HEX=%02.2B]\ [POS=%04l,%04v][%p%%]\ [LEN=%L]
...
argglobal
enew
file ~/diverse/programmering/LudumDare/24/client/src/__Tagbar__
setlocal keymap=
setlocal noarabic
setlocal autoindent
